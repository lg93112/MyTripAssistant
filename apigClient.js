...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://biz5jzki38.execute-api.us-east-1.amazonaws.com/test';
    ...
    apigClient.recbyidGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var recbyidGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/recbyid').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
        ...
        return apiGatewayClient.makeRequest(recbyidGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.recbyidOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var recbyidOptionsRequest = {
        ...
        return apiGatewayClient.makeRequest(recbyidOptionsRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.recbyidtimeGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var recbyidtimeGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/recbyidtime').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(recbyidtimeGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.recbyidtimeOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var recbyidtimeOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/recbyidtime').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(recbyidtimeOptionsRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.sendemailPost = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['name', 'email'], ['body']);
        ...
        var sendemailPostRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['name', 'email']),
            body: body
        };
    ...
    apigClient.sendmessagePost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['phone'], ['body']);
        
        var sendmessagePostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/sendmessage').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['phone']),
            body: body
        };
        
        
        return apiGatewayClient.makeRequest(sendmessagePostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.sendmessageOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var sendmessageOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/sendmessage').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(sendmessageOptionsRequest, authType, additionalParams, config.apiKey);
    };
