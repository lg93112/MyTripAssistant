...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://mtb512jzb8.execute-api.us-east-1.amazonaws.com/test';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'item'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['item']),
            body: body
        };
